...
from app.infrastructure.adapters.persistence.mongo_attack_repository import MongoAttackRepository
from app.infrastructure.adapters.persistence.mongo_critical_repository import MongoCriticalRepository

# Application use cases - Attack
...
# Application use cases - Critical
...
class DependencyContainer:
    ...
    async def initialize(self):
        ...
        self._execute_attack_roll_use_case = ExecuteAttackRollUseCase(self._attack_domain_service)
        self._apply_attack_results_use_case = ApplyAttackResultsUseCase(self._attack_domain_service)
        
        # Initialize Critical use cases
        self._create_critical_use_case = CreateCriticalUseCase(self._critical_repository)
        self._get_critical_use_case = GetCriticalUseCase(self._critical_repository)
        self._update_critical_use_case = UpdateCriticalUseCase(self._critical_repository)
